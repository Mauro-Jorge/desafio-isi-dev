...
def calculate_final_price(product: Product) -> Tuple[Decimal, Optional[DiscountDetails]]:
    """Helper para calcular o preço final e os detalhes do desconto."""
    ...
    else: # Caso não haja um tipo de desconto válido
        return product.price, None

    # Arredonda e garante preço mínimo de 0.01
...
def map_product_to_read_schema(product: Product) -> ProductRead:
    ...
    # Converte o objeto do banco para um dicionário e depois para o schema de leitura
